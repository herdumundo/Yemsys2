...
<html lang="en">
    ...
    <script src="js/ptc/enviar_datos.js" type="text/javascript"></script>
    <script src="js/ptc/envio_retenido_liberado.js" type="text/javascript"></script>
    <script src="js/ptc/traer_clases.js" type="text/javascript"></script>
    <script src="js/ptc/transferencia.js" type="text/javascript"></script>
    ...
    <script src="plugins/canvasjs.min.js" type="text/javascript"></script>
         ...
         <script src="js/mis/formulas.js" type="text/javascript"></script>
         <script src="js/mis/traer_clases.js" type="text/javascript"></script>
         <script src="js/mis/transferencia.js" type="text/javascript"></script>
         
         <script src="js/mis/formulas_mis.js" type="text/javascript"></script>
         <script src="js/mis/traer_clases_mis.js" type="text/javascript"></script>
         <script src="js/mis/transferencia_mis.js" type="text/javascript"></script>
</body>
</html>
